<?php
/*
Plugin Name: SeeReferrers Plugin
...
add_action('admin_menu', 'seereferrers_plugin_add_pages');
register_activation_hook(__FILE__,'referrer_install');

// action function for above hook
function seereferrers_plugin_add_pages() {
    add_options_page('SeeReferrers Plugin', 'SeeReferrers Plugin', 'administrator', 'seereferrers_plugin', 'seereferrers_plugin_options_page');
}
...
// seereferrers_plugin_options_page() displays the page content for the Test Options submenu
function seereferrers_plugin_options_page() {
...
<?php
    ...
    echo "<h2>" . __( 'SeeReferrers Plugin Plugin Options', 'mt_trans_domain' ) . "</h2>";
...
register_sidebar_widget('SeeReferrers Plugin', 'show_referrer');
}
